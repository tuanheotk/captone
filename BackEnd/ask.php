...
<section>
    <div class="container">
        ...
        <div class="card w-75" id="list-question">
            ...
            $sql_get_all_question = "SELECT q.*, COUNT(r.user_id) AS num_like FROM question q LEFT JOIN reaction r ON q.id = r.question_id WHERE q.status = 1 AND q.event_id = $event_id GROUP BY q.id ORDER BY q.pinned DESC, q.id DESC";
