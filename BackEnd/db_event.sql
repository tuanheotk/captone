...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 13, 2020 lúc 04:41 PM
...
(31, 78, 'guest_29250', 'Người Lạ 29250', 'trả lời rồi nè', '2020-04-05 21:31:11'),
(31, 67, 'guest_49886', 'Người Lạ 49886', 'trả lời realtime', '2020-04-07 14:10:55'),
(31, 79, 'guest_49886', 'Người Lạ 49886', 'lên câu trả lời nè nha', '2020-04-07 14:11:20');
...
(45, 33, 'tamtang@gmail.com', 0),
(46, 31, 'tamtang@gmail.com', 0);
...
INSERT INTO `poll` (`id`, `event_id`, `title`, `max_choice`, `status`) VALUES
(3, 31, 'khảo sát lần 1', 2, 1),
(4, 31, 'khảo sát lần hai', 1, 1),
(8, 31, 'tui muốn khảo sát nè', 3, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `poll_option`
--
...
--
-- Đang đổ dữ liệu cho bảng `poll_option`
--

INSERT INTO `poll_option` (`id`, `poll_id`, `content`) VALUES
(5, 3, 'lựa chọn 1'),
(6, 3, 'lựa chọn 2 dt'),
(7, 3, 'lựa chọn 3'),
(8, 3, 'lựa chọn 4 dt'),
...
--
-- Cấu trúc bảng cho bảng `poll_vote`
--
...
--
-- Đang đổ dữ liệu cho bảng `poll_vote`
--

INSERT INTO `poll_vote` (`user_id`, `option_id`) VALUES
('11', 5),
('11', 6),
('2', 6),
('2', 8),
...
(50, '10', 31, 'Bùi Trung Tuấn', 'duyệt câu hỏi đi', 0, '2020-03-20 20:16:07', 0),
(52, '10', 31, 'Bùi Trung Tuấn', 'Câu hỏi đã sửa nè', 0, '2020-03-20 20:21:57', 0),
...
(67, '2', 31, 'Đường Tăng', 'cho hỏi đường đi đến tây thiên', 1, '2020-03-21 20:03:16', 1),
...
(80, 'guest_91019', 31, 'Người Lạ 91019', 'Người lạ đặt câu hỏi $objPHPExcel->getActiveSheet()->getColumnDimension(\'B\')->setAutoSize(true);$objPHPExcel->getActiveSheet()->getColumnDimension(\'B\')->setAutoSize(true);$objPHPExcel->getActiveSheet()->getColumnDimension(\'B\')->setAutoSize(true);', 0, '2020-03-31 13:43:18', 0);
...
--
-- AUTO_INCREMENT cho bảng `poll_option`
--
ALTER TABLE `poll_option`
