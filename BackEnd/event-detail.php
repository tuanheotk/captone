		...
		<div class="rows banner_book" id="inner-page-title">
			<div class="container">
				...
				<li class="dl1"><?php echo $resultevent["place"] ?></li>
                        <li class="dl2">Vé còn lại: 500/<?php echo $resultevent["ticket_number"] ?></li>
                        <li class="dl3">Thời gian: <?php echo date ("H:i d/m/Y", strtotime($resultevent["start_date"])) ?></li>
                        <li class="dl4"><a data-toggle="modal" data-target="#exampleModal1" class="cancel_button" >Đăng kí</a> </li>
				</div>
			</div>
		</div>
	</section>
